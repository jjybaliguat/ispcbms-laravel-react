            ...
            .post('/pay-via-ewallet', {
                ...
                channel_properties: {
                    success_redirect_url:
                        'https://sierracommunication.com/dashboard',
    ...
    useEffect(() => {
        ...
        loadScript('https://js.xendit.co/v1/xendit.min.js', 'xendit-script')
            .then(() => {
                ...
                Xendit.setPublishableKey('xnd_public_development_1BY7UGWM1EqNWLOF_iPdH774Bfrj6kCy2l4cljUMzKf1zLkHceVbILkMOp9slnW')
            })
            .catch(error =>
